...
PALABRAS_SEPARACION = set([
    ...
    "y","o","a","tipo","uso","entre","sobre",
    # Materiales
    "acero","caucho","aluminio","plastico","goma","nylon","nitrilo","bronce","cobre",
    "papel","celulosa","tela","malla","carbono","ceramica","vidrio","laton",
    "fluorocarbono","poliuretano","vulcanizado","sintetico","textil","metalico",
    # Componentes base
    "filtro","sello","junta","perno","tuerca","arandela","tornillo","pasador",
    "grapa","aro","anillo","resorte","vastago","piston","cilindro","valvula",
    "bomba","motor","eje","engranaje","correa","cadena","polea","rodillo",
    "zapata","oruga","eslabon","manguera","tubo","brida","codo","niple",
    "adaptador","conector","tapa","cubierta","carcasa","soporte","placa",
    "chapa","panel","protector","brazo","balde","cuchilla","palanca","manija",
    "perilla","sensor","cable","mazo","cables","radiador","ventilador","buje",
    "manguito","reten","cojinete","espaciador","laina","abrazadera",
    "bulon","esparrago","clavija","tapon","interruptor","alternador",
    "inyector","tobera","acople","amortiguador","compresor","turbocargador",
    "cartucho","elemento","colador","maza","conjunto","juego","kit","grupo",
    "oring","ring","segmento","suplemento","sujetador","retenedor",
    "pasante","orificio","orificios","perforacion","perforaciones","buloneria",
    # Adjetivos técnicos
    "hexagonal","rectangular","circular","redondo","ondulado","ondulada",
    "reforzado","mecanizado","soldado","soldada","plegado","recto","conico",
    "cilindrico","esferico","delantero","trasero","lateral","superior",
    "inferior","central","interno","externo","hidraulico","neumatico",
    "electrico","mecanico","termico","simple","doble","triple","radial",
    "axial","macho","hembra","antifriccion","plano","hueco","solido",
    "trenzada","trenzado","giratoria","giratorio","mecanizada","fundicion",
    "tubular","tensionador","guardabarro","guardabarros",
    # Técnicos específicos
    "presion","retencion","transmision","freno","embrague","diferencial",
    "alimentacion","conexion","zocalo","termoplastico","extremos","extremo",
    "diametro","longitud","espesor","ajuste","montaje","sujecion","armado",
    "completo","original","izquierdo","derecho","frontal","posterior",
    "primario","secundario","principal","auxiliar","desgaste","proteccion",
    "aleacion","borde","corte","nucleo","intercambiador","calor","bloque",
    "manifold","modulo","tablero","operador","atenuador","base","tanque",
    "fluido","carrete","cuerpo","plancha","banda","espiral","capot","barrero",
    "abulonar","soldadas","soldados","plegada",
    # Industria/contexto
    "minero","mineros","equipos","cabina","camion","tractor","cargador",
    "excavadora","combustible","aceite","agua","aire","grasa","lubricante",
    "refrigerante","escape","admision","general","industrial","agricola",
    "terminal","terminales","parte","sistema","serie","modelo",
